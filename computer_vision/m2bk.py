...
class DatasetHandler:
    def __init__(self):
        ...
        self.image_dir = os.path.join(root_dir_path, "../data/week2-data/rgb")
        self.depth_dir = os.path.join(root_dir_path, "../data/week2-data/depth")
        ...
        self.k = np.array([[640, 0, 640], [0, 480, 480], [0, 0, 1]], dtype=np.float32)
    ...
    def _read_depth(self):
        for i in range(1, self.num_frames + 1):
            ...
            print(
                "Data loading: {0}%".format(int(i / (self.num_frames * 2 - 1) * 100)),
                end="\r",
            )
